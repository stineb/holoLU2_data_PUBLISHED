...
peat_yml_lhnfix     <- read.csv( file="dcpeat_yml_stocker17pnas.csv", skip=30 )
peat_yml_lhnfix_cum <- read.csv( file="dcpeat_cum_yml_stocker17pnas.csv", skip=33 )
peat_lpx            <- read.csv( file="dcpeat_lpx_stocker17pnas.csv", skip=26 )
fluc                <- read.csv( file="luc_co2_emissions_stocker17pnas.csv", skip=30 )
